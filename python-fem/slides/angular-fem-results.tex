\begin{frame}[allowframebreaks]
  ...
  \begin{figure}
    ...
    \begin{subfigure}{0.45\textwidth}
      \centering
      \includegraphics[width=0.65\textwidth]{figures/square_source/scalar_flux_very_fine.png}
      \subcaption{Finer Mesh}
    \end{subfigure}%
  \end{figure}
  \framebreak
  ...
  \begin{figure}
    ...
    \begin{subfigure}{0.45\textwidth}
      \centering
      \includegraphics[width=0.65\textwidth]{figures/square_source/scalar_flux_log_very_fine.png}
      \subcaption{Finer Mesh}
    \end{subfigure}%
  \end{figure}
\end{frame}